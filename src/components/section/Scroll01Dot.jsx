                    ...
                    >
                        <Step data={1} value={1}>
                            <div className="step">
                                ...
                                <p>
                                    In April-May 2021, the World Food Programme
                                    conducted a face-to-face household survey of{' '}
                                    <span className="red">4,498 responses</span>{' '}
                        ...
                        <Step data={2} key={2}>
                            <div className="step">
                                <h2>
                                    The majority are suffering from food
                                    insecurity
                                </h2>
                                <p>
                                    In terms of
                                    ...
                                    , the participants are classified into 4
                                    groups based on CARI food security
                                    indicators given from WFP.
                                </p>
                                {/* <p>{Math.round(progress * 1000) / 10 + '%'}</p> */}
                            </div>
                        </Step>
                        <Step data={3} key={3}>
                            <div className="step">
                                ...
                                <p>
                                    <span className="red">Around half</span> of
                                    household respondents indicated a desire to
                                    migrate, but{' '}
                                    <span className="red">only 6%</span> are
